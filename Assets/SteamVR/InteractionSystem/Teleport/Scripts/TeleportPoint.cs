...
namespace Valve.VR.InteractionSystem
{
	...
	public class TeleportPoint : TeleportMarkerBase
	{
        ...
        public static string switchToSceneStatic;
		...
		void Awake()
		{
            ...
            // Debug.Log("<b>[SteamVR TELEPORT POINT AWAKE]</b> switchScene= " + switchToScene, this);
		...
		void Start()
		{
            ...
            //switchToSceneStatic = switchToScene;
            //switchToScene = "PortalScene";
		...
		public void TeleportToScene()
		{
			...
			{
                // Debug.Log("<b>[SteamVR TELEPORT POINT]</b> switchScene= " + switchToScene + " switchToSceneStatic=" + switchToSceneStatic, this);
